...
// Task variables
var time_step = 5; // Decided on 2500, with 30 time steps 
...
var limit = 100; // Number of trials after which data is saved to CSV
...
function step() {
    ...
    if (count > timeout){
        ...
        console.log('Graph: ' + graph + ' Condition: ' + condition + ' Trial: ' + trial_count + " Trial score: " + trial_score);
